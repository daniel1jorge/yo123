...
<div class="container">
	...
	<div class="container text-left col-md-8">
		<br>
		<br>
		<h2 class="text-primary" text-left><b>Términos y Condiciones de Uso del Sitio Web</h2>
